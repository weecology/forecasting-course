...
* Simples model was white noise or the "mean" model:
...
```{r}
portal_data <- mutate(portal_data, cal_month = as.factor(lubridate::month(month)))
ggplot(portal_data, aes(x = rain, y = NDVI)) +
  geom_point() +
  geom_smooth(method = "lm") +
  facet_wrap(~lubridate::month(month))
```
